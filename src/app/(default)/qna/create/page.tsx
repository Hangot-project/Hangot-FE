              ...
              <div className={styles.rowTable}>
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="labelCheck" className={styles.label}>
                          게시물 공개 여부
                        </label>
                      </th>
                      <td>
                        ...
                        />
                        <label htmlFor="labelCheck" className={styles.checkboxLabel}>
                          비공개 글로 설정
                        </label>{" "}
                        <br />
                        <span className={styles.smallText}>
                          • 비공개 글로 설정 시 마이페이지에서 확인 가능합니다.
                        </span>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="labelEmail" className={styles.label}>
                          이메일 주소
                        </label>
                      </th>
                      <td>
                        <div className={styles.inputExText}>
                          ...
                          <span className={styles.exText}>
                            ...
                            <label htmlFor="agreeEmail">이메일 답변 받기</label>
                          </span>
                        </div>
                        <span className={styles.smallText}>
                          • 신청 및 제안 해주신 내용에 대한 처리결과를 이메일로 알려
                          드리고 있으니, 처리 결과 알림을 제공 받기 위해서 이메일을
                          확인해주시기 바랍니다.
                        </span>
                      </td>
                    </tr>
