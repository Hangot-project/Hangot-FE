          ...
          <div className={styles.list}>
            <ol>
              ...
              <li className={styles.detailList}>
                <h3>데이터 관리</h3>
                <ol>
                  <li onClick={() => handleMenuClick('데이터 다운로드 목록')}>데이터 다운로드 목록</li>
                  <li onClick={() => handleMenuClick('데이터 관심 목록')}>데이터 관심 목록</li>
                  <li onClick={() => handleMenuClick('데이터 요청 목록')}>데이터 요청 목록</li>
                  ...
                  <div>
                    <div disabled="false" id="menu_button1">
                      <div className={`${styles.filter1} ${styles.filter2}`}>
                        <button className={`${styles.button1} ${styles.button2}`} variant="light">
