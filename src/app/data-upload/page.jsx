              ...
              <div className={styles.rowTable}>
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">
                        <label for="inputDetail" className={`${styles.required} ${styles.label}`}>공공데이터 세부 내용</label>
                      </th>
                      <td>
                    ...
                    <tr>
                      <th scope="row">
                        <label for="inputDataTitle" className={`${styles.required} ${styles.label}`}>공공데이터 주제</label>
                      </th>
                      <td>
                        <select id="inputDataTitle" title="주제" className={styles.selection}>
                          <option value>선택해주세요</option>
                          <option value>입학</option>
                          <option value>학생</option>
                          <option value>학사</option>
                          <option value>국제</option>
                          <option value>복지</option>
                          <option value>재정</option>
                          <option value>취창업</option>
                    ...
                    <tr>
                      <th scope="row">
                        <label for="inputInsttName" className={`${styles.required} ${styles.label}`}>공공데이터 제공 기관</label>
                      </th>
                      <td>
                    ...
                    <tr>
                      <th scope="row">
                        <label for="inputCopyRight" className={`${styles.required} ${styles.label}`}>공공데이터 제3저작권자</label>
                      </th>
                      <td>
                        <div className={styles.inputType}>
                          <input
                    ...
                    <tr>
                      <th scope="row">
                        <label for="inputLicense" className={`${styles.required} ${styles.label}`}>라이선스</label>
                      </th>
                      <td>
                        <select id="inputLicense" title="라이선스" className={styles.selection}>
                          <option value>선택해주세요</option>
                          <option value>CC BY</option>
                          <option value>CC BY-NC</option>
                          <option value>CC BY-ND</option>
                          <option value>CC BY-SA</option>
                          <option value>CC BY-NC-SA</option>
                          <option value>CC BY-NC-ND</option>
                        </select>
                      </td>
                    </tr>
                  </tbody>
              ...
              <div className={styles.rowTable}>
                <table>
                  ...
                  <tbody>
                    <tr>
                      <th scope="row">
                        <label for="inputFile" className={`${styles.required} ${styles.label}`}>공공데이터 파일</label>
                      </th>
                      <td>  
                        <div className={styles.insttSearchList}>
                          <input
